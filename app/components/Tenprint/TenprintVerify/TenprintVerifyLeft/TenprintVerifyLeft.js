...
export const TenprintVerifyLeft = props => {
  ...
  const navigation = [
    ...
    {
      title: formatMessage({id:"Rolled Prints"}),
      id: "Rolled",
    ...
    {
      title: formatMessage({id:"Palm Prints"}),
      id: "Palm",
  ...
  // console.log("activePanes", activePanes, ! isActiveTab("Rolled") );
  if (
    activePanes.Flat === false &&
    activePanes.Rolled === true &&
    ! isActiveTab("Rolled")
  ) {
    setTimeout( () => {
      handleNavClick("LeftHandRolled");
